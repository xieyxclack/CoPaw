...
export const i18n: Record<Lang, Record<string, string>> = {
  zh: {
    ...
    "quickstart.tabAliyun": "阿里云 ACK",
    "quickstart.tabAliyunMain": "阿里云 ACK",
    ...
    "quickstart.optionAliyun": "阿里云 Kubernetes（ACK）一键部署",
  ...
  en: {
    ...
    "quickstart.tabWindowsMain": "Windows",
    "quickstart.tabWindowsSub": "(Beta)",
    "quickstart.tabAliyun": "Alibaba Cloud ACK",
    "quickstart.tabAliyunMain": "Alibaba Cloud ACK",
    "quickstart.tabAliyunSub": "",
    "quickstart.tabPipShort": "pip",
    "quickstart.tabUnixShort": "Mac/Linux",
    "quickstart.tabWindowsShort": "Windows",
    "quickstart.tabAliyunShort": "Alibaba Cloud",
    "quickstart.optionAliyun": "Deploy on Alibaba Cloud Kubernetes (ACK)",
